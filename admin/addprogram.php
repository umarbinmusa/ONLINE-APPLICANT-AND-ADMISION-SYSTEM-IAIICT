...
<!-- ################################################################################################ -->
  ...
  $field_with_length = array('name' => 50, 'code' => 10, 'fee' => 10, 'eligibility' => 200, 'description' => 500);
  ...
  $num_semester =$_POST['num_semester'];
  ...
  if (empty($errors)) {
    ...
    $query = "INSERT INTO programs( 
      type, code, name, fee, description, num_semester, duration, eligibility, max_duration) 
      VALUES(
     '{$type}', '{$code}', '{$name}', '{$fee}', '{$description}', '{$num_semester}', '{$duration}', 
     '{$eligibility}', '{$max_duration}')";
    $result = mysqli_query($connection, $query);
    if ($result) {
      echo "<center><b> Program Sucessfully Added ! </b></center>";
    } else {
...
?>
    <div id="content">
        <div class="content_item">
            ...
            <h3 style="color: red; text-align: center">All Filled Are Required *</h3>
            ...
            <br style="clear:both;" />
            <div style="width:200px; float:left;"><p>Fee</p></div>
