    ...
    <?php 
      require_once '../config.php';
        ...
        if(isset($_REQUEST["submit"])){ 
            $admit=$_POST['admit'];
            $query="INSERT INTO `admittedstud` (`email`, `status`) 
            VALUES ('$admit','1')";
            if (mysqli_query($connection, $query)){
                echo "<h3> Student Admitted Successfully</h3>";
            } else {
        ...
        <form action="admit.php" method="POST">
           <label for="fname">Select Sudent in the List and By their Email</label>
            ...
            <option value="" >Select Student to Admit</option>
            <?php
            require_once '../config.php';
            ...
            <input type="submit" name="submit" id="submit" value="Admit">
        </form>
