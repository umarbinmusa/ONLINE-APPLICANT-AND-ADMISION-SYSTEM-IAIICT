...
<!-- ################################################################################################ -->
    ...
    <?php 
      ...
      <label for="text" style="color:black;"><b> USER: <?php echo $username?></b><label> <br>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="admit.php"> <button class="button">Admit Student</button> </a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="reject.php" ><button class="button"> Reject Students</button></a><br/><br/>
    &nbsp;	&nbsp;<a href="studentdetails.php"> <button class="button">Student Details</button> </a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="totalapplicants.php"> <button class="button"> Total Applicant</button></a><br/><br/><br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
</div>
<!-- ################################################################################################ -->
...
<div class="wrapper row5">
  <div id="copyright" class="clear"> 
    ...
    <p class="fl_right">Designed & Developed by <a href="#">IAIICT Class of 2021</a></p>
    <!-- ################################################################################################ --> 
