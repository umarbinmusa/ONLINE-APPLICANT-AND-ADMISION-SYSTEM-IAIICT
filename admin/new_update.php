    ...
    <div id="content">
        <div class="content_item">
            ...
            <form action="new_update.php" method="POST">
             ...
             <?php 
                $update_count = mysqli_num_rows($page_set);
             ...
             <br style="clear:both;" />
              ...
              <br style="clear:both;" />
              <div style="width:430px; float:right;"><p style="padding-top: 15px"><input class="submit" type="submit" name="update_added" value="Add" /> &nbsp;&nbsp; <button><a href="index.php">Cancel</a></button></p></div>
            </form>
            <br style="clear:both;" />
